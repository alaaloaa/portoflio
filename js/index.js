...
for (let i = 0; i < skillsData.length; i++) {
  skillsContainer.innerHTML += `<p>${skillsData[i].title}</p>
...
for (let i = 0; i < projectsData.length; i++) {
  projectsContainer.innerHTML += `<div class="col-md-6 col-sm-6 col-xs-12 w3-margin-bottom">
...
for (let i = 0; i < experienceData.length; i++) {
  experienceContainer.innerHTML += `<div class="w3-container wow fadeInRight">
            <div class="top">
